defmodule SubTrackerElixirWeb.InstrumentController do
  ...
  def instruments(conn, _params) do
    ...
    page_num = Instrument.load_page()
    last_page = Instrument.find_last_page_number(instrument_count)
    min_page = Instrument.find_pagination_min_page(page_num, last_page)
    max_page = Instrument.find_pagination_max_page(page_num, last_page)
